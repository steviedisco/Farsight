...
//
Farsight::Server::Capture::OUTPUTMANAGER::OUTPUTMANAGER() : m_SwapChain(nullptr),
	m_Device(nullptr),
	m_Factory(nullptr),
...
//
Farsight::Server::Capture::OUTPUTMANAGER::~OUTPUTMANAGER()
{
	CleanRefs();
}
...
//
void Farsight::Server::Capture::OUTPUTMANAGER::WindowResize()
{
	m_NeedsResize = true;
}
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::InitOutput(HWND Window, INT SingleOutput, _Out_ UINT* OutCount, _Out_ RECT* DeskBounds)
{
	HRESULT hr;
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::CreateSharedSurf(INT SingleOutput, _Out_ UINT* OutCount, _Out_ RECT* DeskBounds)
{
	HRESULT hr;
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::UpdateApplicationWindow(_In_ PTR_INFO* PointerInfo, _Inout_ bool* Occluded)
{
...
//
HANDLE Farsight::Server::Capture::OUTPUTMANAGER::GetSharedHandle()
{
	HANDLE Hnd = nullptr;
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::DrawFrame()
{
	HRESULT hr;
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::ProcessMonoMask(bool IsMono, _Inout_ PTR_INFO* PtrInfo, _Out_ INT* PtrWidth, _Out_ INT* PtrHeight, _Out_ INT* PtrLeft, _Out_ INT* PtrTop, _Outptr_result_bytebuffer_(*PtrHeight * *PtrWidth * BPP) BYTE** InitBuffer, _Out_ D3D11_BOX* Box)
{
	// Desktop dimensions
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::DrawMouse(_In_ PTR_INFO* PtrInfo)
{
	// Vars to be used
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::InitShaders()
{
	HRESULT hr;
...
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::MakeRTV()
{
	// Get backbuffer
...
// Set new viewport
//
void Farsight::Server::Capture::OUTPUTMANAGER::SetViewPort(UINT Width, UINT Height)
{
	D3D11_VIEWPORT VP;
...
// Resize swapchain
//
DUPL_RETURN Farsight::Server::Capture::OUTPUTMANAGER::ResizeSwapChain()
{
	if (m_RTV)
	{
		m_RTV->Release();
...
//
void Farsight::Server::Capture::OUTPUTMANAGER::CleanRefs()
{
	if (m_VertexShader)
	{
