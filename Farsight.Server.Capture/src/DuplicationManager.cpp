...
//
Farsight::Server::Capture::DUPLICATIONMANAGER::DUPLICATIONMANAGER() : m_DeskDupl(nullptr),
...
//
Farsight::Server::Capture::DUPLICATIONMANAGER::~DUPLICATIONMANAGER()
{
    if (m_DeskDupl)
    {
        m_DeskDupl->Release();
...
//
DUPL_RETURN Farsight::Server::Capture::DUPLICATIONMANAGER::InitDupl(_In_ ID3D11Device* Device, UINT Output)
{
...
//
DUPL_RETURN Farsight::Server::Capture::DUPLICATIONMANAGER::GetMouse(_Inout_ PTR_INFO* PtrInfo, _In_ DXGI_OUTDUPL_FRAME_INFO* FrameInfo, INT OffsetX, INT OffsetY)
{
...
DUPL_RETURN Farsight::Server::Capture::DUPLICATIONMANAGER::GetFrame(_Out_ FRAME_DATA* Data, _Out_ bool* Timeout)
{
...
// Release frame
//
DUPL_RETURN Farsight::Server::Capture::DUPLICATIONMANAGER::DoneWithFrame()
{
...
//
void Farsight::Server::Capture::DUPLICATIONMANAGER::GetOutputDesc(_Out_ DXGI_OUTPUT_DESC* DescPtr)
{
