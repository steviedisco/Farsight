...
//
Farsight::Server::Capture::DISPLAYMANAGER::DISPLAYMANAGER() : m_Device(nullptr),
...
//
Farsight::Server::Capture::DISPLAYMANAGER::~DISPLAYMANAGER()
{
    CleanRefs();
...
//
void Farsight::Server::Capture::DISPLAYMANAGER::InitD3D(DX_RESOURCES* Data)
{
...
//
DUPL_RETURN Farsight::Server::Capture::DISPLAYMANAGER::ProcessFrame(_In_ FRAME_DATA* Data, _Inout_ ID3D11Texture2D* SharedSurf, INT OffsetX, INT OffsetY, _In_ DXGI_OUTPUT_DESC* DeskDesc)
{
...
//
ID3D11Device* Farsight::Server::Capture::DISPLAYMANAGER::GetDevice()
{
    return m_Device;
}
...
//
void Farsight::Server::Capture::DISPLAYMANAGER::SetMoveRect(_Out_ RECT* SrcRect, _Out_ RECT* DestRect, _In_ DXGI_OUTPUT_DESC* DeskDesc, _In_ DXGI_OUTDUPL_MOVE_RECT* MoveRect, INT TexWidth, INT TexHeight)
{
...
//
DUPL_RETURN Farsight::Server::Capture::DISPLAYMANAGER::CopyMove(_Inout_ ID3D11Texture2D* SharedSurf, _In_reads_(MoveCount) DXGI_OUTDUPL_MOVE_RECT* MoveBuffer, UINT MoveCount, INT OffsetX, INT OffsetY, _In_ DXGI_OUTPUT_DESC* DeskDesc, INT TexWidth, INT TexHeight)
{
...
void Farsight::Server::Capture::DISPLAYMANAGER::SetDirtyVert(_Out_writes_(NUMVERTICES) VERTEX* Vertices, _In_ RECT* Dirty, INT OffsetX, INT OffsetY, _In_ DXGI_OUTPUT_DESC* DeskDesc, _In_ D3D11_TEXTURE2D_DESC* FullDesc, _In_ D3D11_TEXTURE2D_DESC* ThisDesc)
{
...
//
DUPL_RETURN Farsight::Server::Capture::DISPLAYMANAGER::CopyDirty(_In_ ID3D11Texture2D* SrcSurface, _Inout_ ID3D11Texture2D* SharedSurf, _In_reads_(DirtyCount) RECT* DirtyBuffer, UINT DirtyCount, INT OffsetX, INT OffsetY, _In_ DXGI_OUTPUT_DESC* DeskDesc)
{
    HRESULT hr;
...
//
void Farsight::Server::Capture::DISPLAYMANAGER::CleanRefs()
{
    if (m_DeviceContext)
    {
